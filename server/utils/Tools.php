...
abstract class Tools {
	...
	public static function printSuccessAlert($text, $dissmisable = true, $styles = '') {
		$msg = '<div class="alert alert-success alert-dismissible fade show ' . $styles . '" role="alert">';
		$msg .= $text;
		if ($dissmisable) {
	...
	public static function printErrorAlert($text, $dissmisable = true, $styles = '') {
		$msg = '<div class="alert alert-danger alert-dismissible fade show ' . $styles . '" role="alert">';
		$msg .= $text;
		if ($dissmisable) {
			$msg .= '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>';
		}
	...
	public static function printWarnAlert($text, $dissmisable = true, $styles = '') {
		$msg = '<div class="alert alert-warning alert-dismissible fade show ' . $styles . '" role="alert">';
		$msg .= $text;
		if ($dissmisable) {
			$msg .= '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>';
		}
